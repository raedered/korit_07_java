...
public class PersonMain {
    public static void main(String[] args) {
        ...
        // Settre / Getter의 사용법 -> 예네는 method라고 햇습니다.
        ...
        // Setter / Getter를 데이터의 입력 / 수정 / 조회를 가능하게 하고
        ...
        // 이상과 같은 코드 라인은 특정 방벅을 사용하면 부정확한 데이터의 입력이 가능
        // 하길 대문에 장기적으로는 method를 통한 데이터의 입력 / 수정 / 조회가 필요함

        //.length()     -> String 자료형의 글자 수를 return하는 method
        //글자수니까 return 자료형흔 int
        System.out.println(person1.name.length());      // 이상의 객체명.메서드명().메서드명() 등으로
        // . . 이 여러 개 나오는 방식을 chaining이라고합니다.
        // 근데 이상과 같이 작성하기 싫어하시는 분들은 중간 과정에 변수를 선헌하시는 분돌ㄹ 있습니다.
