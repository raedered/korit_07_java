...
public class UnivStudent {
    ...
    public void setGrade(int grade) {
        if(grade > 0 && grade < 4){
            System.out.println("잘못된 grade 입력값 \n");

        }
//        if(reGrade < 0 || reGrade > 4){
//            System.out.println("잘못된 grade 입력값 \n");
//            return;
//        }
//        System.out.println("변경전 학년: " + grade);
//        this.grade = reGrade;
//        System.out.println("변경후 학년: " + grade + "\n");
    }

    public void setScore(double reScore) {
        if(reScore < 0.0 || reScore > 4.5) {
            System.out.println("잘못된 score값 \n");
            return;
        }
//        System.out.println("변경전 점수: " + score);
//        this.score = reScore;
//        System.out.println("변경후 점수: " + score + "\n");
    }
