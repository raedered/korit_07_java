...
public class Person {
    ...
    /*
        ...
        여기서 중요한 점음 Person의 필드와 Builder의 필드가 동일해야 한다는 겁니다.
     */
    ...
    public static class Builder {
        ...
        // 그래서 이 위쪽 코드 까지는 field 명과 동일한 메서드들을 정의했습니다.
        // 그 효과는 메서드 명과 동일한 field에 값이 대입된 Builder 객체가 리턴됩니다.
