...
public class ProductViewMain {
    public static void main(String[] args) {
        ...
        // 이상의 코드는 ProductView.Java 를 확인했을때 객체를 생성하는 method입니다.
        // 생서자를 호출하지 않은 이유는 생성자가 private이기 때문이었습니다.
        ...
        /*
            ...
            그래서 static 패키기 내부의 코드와 이번의 ProductView 코드를 비교/ 대조해서
            확인할 필요가 있습니다.

            그리고 기출 문제 싱글톤도 확인하면 더 좋음
         */
    }
}
