...
/*
    방금 작성한 ProductView와 인터넷에서의 래퍼런스를 참조하여
    Samsung 클래스의 싱글톤 패턴을 작성하시오.
 */
public class Samsung {
    // 일반 필드(맴버 변수라는 표현을 쓰기도함)
    ...
    public String createSerialNumber(String model) {
        ...
        // Main 단계에서 다수의 객체에서 createSerialNumber()를 호출하덜도 전혀 serialNumber가 중복되지
        // 않을거라고 볼 수 있습니다.
        // 그러면 정적 변수로 선언하고 다수의 삼성 객체를 만들어도 serialNumber가 안겹치지 안을까요?
        // 라고 질문한다면 맞는 말입니다.
        // 근데 그러면 Samsung이라는 회사 갯수가 백만개라는 전재하에 가능.
    }
}
