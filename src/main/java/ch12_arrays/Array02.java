...
public class Array02 {
    public static void main(String[] args) {
        ...
        // 그럼 그 이후에 5명 자리를 등록할 수 잇는 빈 배열이 생성되어야 합니다.
        Scanner scanner = new Scanner(System.in);
        int human = 0;
        System.out.print("몇 명의 학생을 등록하시겟습니까? >>> ");
        ...
        for(int i = 0; i < humans.length; i++){
            System.out.print((i + 1) + " 번 학생의 이름을 등록해주세요 >>> ");
            humans[i] = scanner.nextLine();
        }

        // humans라고 하는 배열의 크기와 scores라는 배열의 크기는 동일해야합니다.
        // 빈 배열의 선언 및 크기 지정을 할 때 어던 변수를 사용할 수 있는가.

        // 총합을 낼거니까
        double sum = 0;
        // 이건 direction을 모두 반영한 코드라고 할 수 있겠습니다.
        for(int i = 0; i < humans.length; i++) {        //  humans.length나 scores.length나 human이나 다 같습니다.
...
//        }
        ...
        // index는 0부터 시작인데 굳이 1로 지정해줘야하기 때문에 오이려
