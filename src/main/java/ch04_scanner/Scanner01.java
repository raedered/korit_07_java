...
//        name = scanner.nextLine();
        /*
             ...
             2. nextLine / nextInt / 어쩌고저쩌고 이런 것을이 있겠다. 구분해야겠다.
...
//        name = scanner.next();      // 입력을 ahn jeunsu
//        System.out.println(name);
        /*
            2. next(Int / Double, ...etc) vs. nextLine
                - nextLine은 띄어쓰기를 허용합니다. -> 그래서 24번 라인 실행결과가 ahn 이었습니다
...
//        System.out.println("이름 : "  + name);
        ...
        /*
            ...
            그 경우 다음 nextLine()에서는 enter키를 받아들여서 빈값인 enter를 쳤다고
            인지하게 되기 때문에
