...
/*
    ...
    Pascal case -> 첫 번째 문자가 대문자고 나머지는 소문자로 가다가 두번째 단어의 첫 번째 문자는 또 대문자
        ex) 한 단어 짜리 : Operator01
        ex) 복수 단어 : OpertorTestResult       -> Pascal Case는 클래스 명명 규칙에 해당합니다.
 */
public class Operator01 {
    public static void main(String[] args) {
        ...
        /*
            ...
            그렇다면 왼쪽과 오른쪽이 같은 갑이다. 라고 표실 할때는 어떻게 할까요? ==
        ...
        // 그래서 생각보다 콜딩할 때도 얘네가 멍청해서 하나하나 잘 지정해야합니다.
        // 즉 개발자는 뭐다??
