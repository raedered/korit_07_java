...
public class StrSet {
    public static void main(String[] args) {
        // Set 객체 생성
        Set<String> strSet = new HashSet<>();   // 빨간거 떳을 때 alt + enter
        // List 객체도 생성
        ArrayList<String> strList = new ArrayList<>();

        // List / Set에 element 추가하는 방법은 동일합니다. 리스트of셋명.add(element);
        strList.add("java");
        strList.add("java");
        strList.add("java");
        strList.add("python");
        ...
        System.out.println(strList);        // 원래 Listsms 그대로 유지
        System.out.println(strSet);         // Set에 element들이 덯해지긴 했는데,
