...
public class StrMap {
    public static void main(String[] args) {
        ...
        /*
            ...
            하지만 Map의 경우 아까 추력결과에서 본 것처럼 순서를 보장하지 않기 때문에
            .get("키갑"); 을 통해 조회가 가능합니다.
         */
        ...
        koreanScores1.put("김일", new Double[2]);     // 이건 자료구조가 복잡.
        ...
        boolean searchValueFlag1 = strMap1.containsKey("김삼");
        System.out.println("김삼 존재 여부 : " + searchValueFlag1);

        // Map의 멘트리로부터 Set을 생성
        Set<Map.Entry<String, String>> entrySet1 = new HashSet<>();
        // 이상의 코드는 Set을 하나 만드는데, 내부에 Key가 String, Value가 String 인 Map이 xhdWofh
        // 들어간다는 것을 의미합니다.
        Set<Map.Entry<String, String>> entrySet2 = strMap1.entrySet();
        // 이상의 코드는 strMap1의 key-value 쌍을 Set으로 바꾸는 메서드인 .entrySet()의 호출 결과를
...
//        List<Map.Entry<String, String>> entryList2 = strMap1.entrySet();
        ...
        // Value Set 출력
//        Set<String> valueSet = strMap1.values(); 이게 불가능한 이유는 뭘가요 ?
        /*
