...
public class ForEachMain {
    public static void main(String[] args) {
        // List 생성 -> 빈거 생성하고 넣는거 말고 바로 만들것비니다.
        // 즉, 선언 및 초기화 방식
        List<String> fruits = Arrays.asList("사과", "딸기", "블루베리"  );

        System.out.println(fruits);

        // 여시거 저희는 각element를 추출하기 위해서 for문 / 향상된 for문을 사용해왔습니다.

        // 과일명 : 사과
        // 과일명 : 딸기
        // 과일명 : 블루베리
        // 이상과 갘은 방식으로 element를 추출 하고 가공하기 위해서는 필수적이었다고 할 수 있습니다.
        ...
        // 하지만 forEach() 매서드 '내'에 람다식을 작성함으로써
        // 읽을 수 만 있다면 가독성 있는 형태로 데이터를 가공할 수 있음을 확인했습니다.
