...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(add.calculate(2, 3));    // 15번 라인의 주석을 참고했을 때의 올마른 메서드 호출 방식
        System.out.println(sub.calculate(2, 3));    // 근데 너무 길어서 저희는 static method를 정희했습니다.
        System.out.println("--- static method 호출 방식 결과 ---");
        System.out.println("2 + 3 = " + operate(2, 3, add));       // static method의 로직을 보시면
        // 새번째 매개변수로 Calculator 인터페이스의 서브 클래스를 받습니다.
        // 그리고 return 문을 보시면 해당 객체의 .calculate() 메서드를 호출하는 것을 확인할 수 있습니다.
        // 근데 add.calculate()는 return이 x + y니까, 경과값이 5가 나왔겠네요.
