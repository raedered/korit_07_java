...
public class JSON2 {
    public static void main(String[] args) {
        ...
        /*
            ...
            하시오
            그리고 JSON1.java 파일을 참조해서 json데이터로 바꿔보시오
         */
        ...
        /*
            ...
            즉, toJson()은 overloading이 이루어졌다고 볼 수 있겠네요.
            
            그리고 gson 객체에서도 toJson()이 있고 gsonBuilder 에서도 toJson()이 있다는 점 또한 주목할 부분입니다.
            
            그 다음은 json -> Map / Java objext로 바꾸는 방식도 있습니다.
        ...
        /*
            ...
            이상인 이유는 fromJson()이라는 메서드 명에서 알 수 있듯이
            JsonData(즉 String Data)를 Map으로 바꾸는 겁니다.
            String의 경우에는 개행을 통해서 prettyPriting이 적용될 수 있지만,
            Map은 toString() 메서드를 재정의 하지 않으면 default값 형대로 콘솔에 출력이 되겠죠.
