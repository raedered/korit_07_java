...
public class Main {
    public static void main(String[] args) {
        ...
        // 업캐스팅 방법 # 2
        // 새로운 변수를 선언하여 캐스팅이 이루어진 대이터를 집어넣는 방법입니다.
        char cast3 = 'b';
        int casted3 = cast3;        // 여기서는 (int)로 안쓰엿죠.
...
//        System.out.println("변형 : " + casted5);
        ...
        /*
            ...
            되니까 기존 데이터가 변형이 일어날 가능성이 없어서 암시적(import)
            downcasting의 경우에는 데이터 용량이 축서되는 과정에서 변수가 메모리 용량을 벗어나게 되는 경우가 있습니다
            용량 오버에 해당하는 현상을 미리 점검하기 위해 다운캐
         */
